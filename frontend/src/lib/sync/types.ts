...
export type OutboxStatus = 'pending' | 'syncing' | 'synced' | 'error' | 'canceled'
...
export type NlQueueStatus = 'pending' | 'processing' | 'completed' | 'failed' | 'canceled'
...
export type ConflictReason = 'update_precondition_failed' | 'deleted_on_server' | 'other'
export type ConflictStatus = 'pending_review' | 'manually_resolved' | 'dismissed'
